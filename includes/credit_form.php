...
<form action="transactions.php" id="TransactionAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"/></div>	<fieldset>
	...
	<div class="input number required"><label for="TransactionKeyID">Key ID</label><input name="key_id" step="any" type="text" id="TransactionKeyID" value="<?php echo $key_id; ?>" required="required"/>
					...
					<div class="input text"><label for="TransactionCcnumber">Ccnumber</label><input name="ccnumber" value="<?php echo $ccnumber; ?>" maxlength="20" type="text" id="TransactionCcnumber"/></div><div class="input text"><label for="TransactionCcexp">Ccexp</label><input name="ccexp" value="1010" maxlength="4" type="text" id="TransactionCcexp"/></div>		
	<div class="input number required"><label for="TransactionAmount">Amount</label><input name="amount" step="any" type="text" id="TransactionAmount" required="required" value="<?php echo $amount; ?>" />
	</div>
